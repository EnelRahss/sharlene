 ...
 */
final class Version20240513120315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE followup (id INT AUTO_INCREMENT NOT NULL, cleaner_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status TINYINT(1) NOT NULL, content VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, INDEX IDX_1D1A7A3BEDDDAE19 (cleaner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE housing (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, surface INT DEFAULT NULL, url_rent VARCHAR(255) DEFAULT NULL, keybox TINYINT(1) NOT NULL, arrival_time DATETIME DEFAULT NULL, departure_time DATETIME DEFAULT NULL, INDEX IDX_FB8142C3F5B7AF75 (address_id), INDEX IDX_FB8142C37E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
