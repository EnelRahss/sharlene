    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('title', TextType::class, [
                ...
                'required' => true,
                'empty_data' => '',
                'attr' => ['class'=>"block w-full rounded-md 
                border-0 py-1.5 text-gold shadow-sm 
                ring-1 ring-inset ring-gray-300 
                placeholder:text-gold focus:ring-2 
                focus:ring-inset focus:ring-indigo-600 
                sm:text-sm sm:leading-6"],
                'label_attr' => ['class'=>"block text-sm 
                font-medium leading-6 text-gold"],
                'sanitize_html' => true,
            ])
            ->add('createAt', null, [
                'label' => 'Quand ? ',
